...
*/
package top.ironmanzzm.geosot

import top.ironmanzzm.geosot
import top.ironmanzzm.geosot.common._
...
class Grid {
    ...
    private var code_ : MortonCode = geosot.MortonCode(longitude_, latitude_, elevation_)
...
object Grid {
    ...
    def apply(lat: String, lon: String, level: Int): Grid = {
        ...
        obj.level_ = level
        obj.code_ = geosot.MortonCode(obj.longitude_, obj.latitude_)
        obj
    }
    ...
    def apply(lat: String, lon: String, elev: String, level: Int): Grid = {
        ...
        obj.level_ = level
        obj.code_ = geosot.MortonCode(obj.longitude_, obj.latitude_, obj.elevation_)
        obj
    }
}
